...
# in the full set mentioned above as part of your make commandline
  AB_OTA_PARTITIONS ?= system system_ext vendor
else
...
BOARD_KERNEL_CMDLINE := console=hvc0,115200 debug user_debug=31 loglevel=9 print-fatal-signals=1 androidboot.console=ttyAMA0 androidboot.hardware=qcom androidboot.selinux=enforcing androidboot.memcg=1 init=/init swiotlb=2048 androidboot.usbcontroller=a600000.dwc3 androidboot.recover_usb=1 firmware_class.path=/vendor/firmware_mnt/image pcie_ports=compat kpti=0 msm_cfg.cfg_sel=1 androidboot.dtbo_idx=1
