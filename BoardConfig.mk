...
# in the full set mentioned above as part of your make commandline
  AB_OTA_PARTITIONS ?= system system_ext vendor vbmeta
else
...
BOARD_KERNEL_CMDLINE := console=hvc0,115200 debug user_debug=31 loglevel=9 print-fatal-signals=1 androidboot.console=ttyAMA0 androidboot.hardware=qcom androidboot.selinux=enforcing androidboot.memcg=1 init=/init swiotlb=4096 androidboot.recover_usb=1 kpti=0 pcie_ports=compat firmware_class.path=/vendor/firmware_mnt/image loop.max_part=7 androidboot.dtbo_idx=1 msm_rtb.filter=0x237
